...
import static com.restaurant_elections.web.user.ProfileController.REST_URL;
import static com.restaurant_elections.web.user.UserTestData.*;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    @Test
    void registerHtmlUnsafe() throws Exception {
        UserTo newTo = new UserTo(null, "<script>alert(123)</script>", "newemail@ya.ru", "newPassword");
